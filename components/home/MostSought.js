			...
			<div className={`${styles.sought_pashmina} ${styles.content_size}`}>
				...
				<div className={`${styles.sought_pashmina_row}`}>
					<div className={`${styles.soughtpashmina_three} ${styles.soughtpashmina_col}`}>
						<img src="images/first.jpg" alt="img" className={`${styles.soughtpashmina_img}`} />
						<h3>All Over (Jaal)</h3>
						<p>Sed ut perspiciatis unde omnis iste natus error sit volup tatem accus antium dolore.</p>
						<ul>
